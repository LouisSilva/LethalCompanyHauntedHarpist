...
//     [HarmonyPostfix]
//     private static void CreateShotgunId(ShotgunItem __instance)
//     {
//         EnforcerGhostShotgunAnimationRegistry.AddShotgun(__instance);
//     }
// }
...
//         
//         Debug.Log("Shotgun passed all the vibe checks");
//         
...
//     private static readonly Dictionary<string, CustomShotgunAnimationController> ShotgunToCustomAnimationMap = new();
//
//     private class ShotgunObjectComparer : IEqualityComparer<ShotgunItem>
//     {
//         public bool Equals(ShotgunItem x, ShotgunItem y)
//         {
//             return x.Id = y.Id
//         }
//     }
...
//     {
//         public ShotgunItem Shotgun { get; set; } = shotgun;
...
//
//         string shotgunId = Guid.NewGuid().ToString();
...
//         ShotgunToCustomAnimationMap[shotgunId] = new CustomShotgunAnimationController(
//             shotgun,
...
//     }
//
//     public static string GetShotgunId(ShotgunItem shotgun)
//     {
//         if (!ShotgunToCustomAnimationMap.TryGetValue(shotgun))
//     }
//
