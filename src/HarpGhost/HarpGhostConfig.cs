...
public class HarpGhostConfig : SyncedInstance<HarpGhostConfig>
{
    ...
    public readonly ConfigEntry<float> HarpGhostHearingPrecision;
    ...
    public HarpGhostConfig(ConfigFile cfg)
    {
        ...
        HarpGhostSpawnRarity = cfg.Bind(
            ...
            "Modded:20,ExperimentationLevel:0,AssuranceLevel:0,VowLevel:0,OffenseLevel:0,MarchLevel:0,RendLevel:200,DineLevel:200,TitanLevel:50,Adamance:0,Embrion:0,Artifice:35,Auralis:0,Atlantica:0,Acidir:200,Cosmocos:35,Asteroid:5,Desolation:60,Etern:0,Gloom:60,Gratar:0,Infernis:0,Junic:15,Oldred:0,Polarus:0,Seichi:1,Cesspool:25,Orion:5,EGypt:10",
        ...
        HarpGhostHearingPrecision = cfg.Bind(
            "Haunted Harpist General",
            "Hearing Precision",
            90f,
            "Controls how accurately the harpist locates a noise. A value of 100 means the enemy's precision is 100% accurate, while lower values result in a broader search area."
        );
